	...
	if ( file_exists( "../promenne.php" ) && require( "../promenne.php" ) )
	{
		...
		{ 
			...
			if ( isset($_REQUEST['form_add']) ) //kontrola vložení dne
			{
				...
				else if ( $_REQUEST['vedouci'] == "" || $_REQUEST['dira1'] == "" || $_REQUEST['dira2'] == "" || ($_REQUEST['colspan1'] && $_REQUEST['gMor1'] == "") || ($_REQUEST['colspan2'] && $_REQUEST['gMor2'] == "") || ($_REQUEST['colspan3'] && $_REQUEST['gAf1'] == "") || ($_REQUEST['colspan4'] && $_REQUEST['gAf2'] == "") || ($_REQUEST['colspan5'] && $_REQUEST['gNig'] == "") ) $warning_everyone = true;
				else if ( $_REQUEST['vedouci'] == $_REQUEST['dira1'] || $_REQUEST['vedouci'] == $_REQUEST['dira2'] || $_REQUEST['dira1'] == $_REQUEST['dira2'] ) $warning_dira_velden = true;
			...
			if ( isset($_REQUEST['form_modify']) ) //kontrola upravy dne
			{
				...
				else if ( !isset($_REQUEST['gMor1']) || !isset($_REQUEST['gMor2']) || !isset($_REQUEST['gAf1']) || !isset($_REQUEST['gAf2']) || !isset($_REQUEST['gNig']) ) $warning_everyone = true;
				else if ( $_REQUEST['vedouci'] == "" || $_REQUEST['dira1'] == "" || $_REQUEST['dira2'] == "" || ($_REQUEST['colspan1'] && $_REQUEST['gMor1'] == "") || ($_REQUEST['colspan2'] && $_REQUEST['gMor2'] == "") || ($_REQUEST['colspan3'] && $_REQUEST['gAf1'] == "") || ($_REQUEST['colspan4'] && $_REQUEST['gAf2'] == "") || ($_REQUEST['colspan5'] && $_REQUEST['gNig'] == "") ) $warning_everyone = true;
				else if ( $_REQUEST['vedouci'] == $_REQUEST['dira1'] || $_REQUEST['vedouci'] == $_REQUEST['dira2'] || $_REQUEST['dira1'] == $_REQUEST['dira2'] ) $warning_dira_velden = true;
			...
			if ( !$warning_colspan && !$warning_colspan2 && !$warning_colspan_int && !$warning_day && !$warning_day_number && !$warning_day_exists && !$warning_other && !$warning_dira_velden && !$warning_everyone )
			{
				if ( isset($_REQUEST['form_add']) )//insert new day
				{
					...
					$query .= ", vedouci, dira1, dira2, Mor1, gMor1, colspan1, etapa1, Mor2, gMor2, colspan2, etapa2, Af1, gAf1, colspan3, etapa3, Af2, gAf2, colspan4, etapa4, Nig, gNig, colspan5, etapa5 )";
					$query .= " VALUES (";
					$query .= " '".$name."', '".$_REQUEST['datum']."<br />".$_REQUEST['dayInWeek']."'";
					$query .= ", ".$_REQUEST['den'];
				...
				else if ( isset($_REQUEST['form_modify']) ) //update day
				{
					...
					$query = "UPDATE ".$sql_table." SET `changed` = '".$name."', datum = '".$_REQUEST['datum']."<br />".$_REQUEST['dayInWeek']."'";
					...
					$query .= ", etapa3 = ".$_REQUEST['colspan3'];
