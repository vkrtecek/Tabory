...
<?php if ( isset($_REQUEST['form_add']) && $saved ) {?>
    ...
    if ( $_REQUEST['colspan1'] ) $item .= '<td colspan="'.$_REQUEST['colspan1'].'">'.toHacky( $_REQUEST['gMor1'], $spojeni ).'</td>';
    if ( $_REQUEST['colspan2'] ) $item .= '<td colspan="'.$_REQUEST['colspan2'].'">'.toHacky( $_REQUEST['gMor2'], $spojeni ).'</td>';
    if ( $_REQUEST['colspan3'] ) $item .= '<td colspan="'.$_REQUEST['colspan3'].'">'.toHacky( $_REQUEST['gAf1'], $spojeni ).'</td>';
    if ( $_REQUEST['colspan4'] ) $item .= '<td colspan="'.$_REQUEST['colspan4'].'">'.toHacky( $_REQUEST['gAf2'], $spojeni ).'</td>';
    if ( $_REQUEST['colspan5'] ) $item .= '<td>'.toHacky( $_REQUEST['gNig'], $spojeni ).'</td>';
    $item .= '</tr>';
    ...
    <tr><td>Den č.: </td><td><input type="text" name="den" value="<?php echo isset($_REQUEST['den']) ? $_REQUEST['den'] : ""; ?>"/><?php echo $warning_day ? '<p class="red"><strong>Den je větší než '.$DAY_MAX.' či jiná blbost.</strong></p>' : ''; echo $warning_day_exists ? '<p class="red"><strong>Tento den již je v databázi.</strong></p>' : ''; echo $warning_day_number ? '<p class="red"><strong>Den není číslo.</strong></p>' : ''; ?></td></tr>
    <tr><td>Datum: </td><td><input type="text" name="datum" value="<?php echo isset($_REQUEST['datum']) ? $_REQUEST['datum'] : ""; ?>"/>
    ...
    <table rules="none" class="addDayTable">
    <tr><td>Program: </td><td><textarea name="Mor1"><?php echo isset($_REQUEST['Mor1']) ? $_REQUEST['Mor1'] : ""; ?></textarea></td></tr>
	...
	<?php
        ...
        <select name="gMor1[]" id="Mor1<?php echo $i;?>">
            ...
            ?>
        </select><img src="imgs/delete.png" alt="minus" id="Del-Mor1-<?php echo $i++;?>" class="manipulate minus" title="odtaranit vykonavatele" />
        <?php
		}
        ...
        ?>
            ...
            </select><img src="imgs/delete.png" alt="minus" id="Del-Mor1-<?php echo $i;?>" class="manipulate minus toHide" title="odtaranit vykonavatele" />
        <?php
        }
    ?>
    <img src="imgs/plus.png" alt="plus" id="Add-Mor1" class="manipulate plus" title="přidat vykonavatele" />
    </td></tr>
    <tr><td>Počet bloků: </td><td><input class="cislo" type="text" name="colspan1" id="DB1" value="<?php echo isset($_REQUEST['colspan1']) ? $_REQUEST['colspan1'] : 1; ?>"/></td></tr>
    <tr>
        <td>Etapa:</td>
        <td><select name="etapa1">
            <option value="0" <?php if ( isset($_REQUEST['etapa1']) && $_REQUEST['etapa1'] == 0 ) echo 'selected=""'; ?>>NE</option>
            <option value="1" <?php if ( isset($_REQUEST['etapa1']) && $_REQUEST['etapa1'] == 1 ) echo 'selected=""'; ?>>ANO</option>
        </select></td>
    </tr>
    </table>
    <hr />
    ...
    <table rules="none" class="addDayTable">
    <tr><td>Program: </td><td><textarea name="Mor2"><?php echo isset($_REQUEST['Mor2']) ? $_REQUEST['Mor2'] : ""; ?></textarea></td></tr>
    <tr><td>Má na starosti: </td><td>
    <?php
        $i = 0;
        ...
        <select name="gMor2[]" id="Mor2<?php echo $i;?>">
            ...
            ?>
        </select><img src="imgs/delete.png" alt="minus" id="Del-Mor2-<?php echo $i++;?>" class="manipulate minus" title="odtaranit vykonavatele" />
        <?php
		}
        for ( ; $i < $max_of_doers; $i++ ){
        ?>
            ...
            </select><img src="imgs/delete.png" alt="minus" id="Del-Mor2-<?php echo $i;?>" class="manipulate minus toHide" title="odtaranit vykonavatele" />
        <?php
        }
    ?>
    <img src="imgs/plus.png" alt="plus" id="Add-Mor2" class="manipulate plus" title="přidat vykonavatele" />
    </td></tr>
    <tr><td>Počet bloků: </td><td><input class="cislo" type="text" name="colspan2" id="DB2" value="<?php echo isset($_REQUEST['colspan2']) ? $_REQUEST['colspan2'] : 1; ?>"/></td></tr>
    <tr>
        <td>Etapa:</td>
        <td><select name="etapa2">
            <option value="0" <?php if ( isset($_REQUEST['etapa2']) && $_REQUEST['etapa2'] == 0 ) echo 'selected=""'; ?>>NE</option>
            <option value="1" <?php if ( isset($_REQUEST['etapa2']) && $_REQUEST['etapa2'] == 1 ) echo 'selected=""'; ?>>ANO</option>
        </select></td>
    </tr>
    </table>
    <hr />
    ...
    <table rules="none" class="addDayTable">
    <tr><td>Program: </td><td><textarea name="Af1"><?php echo isset($_REQUEST['Af1']) ? $_REQUEST['Af1'] : ""; ?></textarea></td></tr>
    <tr><td>Má na starosti: </td><td>
    <?php
        $i = 0;
        ...
        <select name="gAf1[]" id="Af1<?php echo $i;?>">
            ...
            ?>
        </select><img src="imgs/delete.png" alt="minus" id="Del-Af1-<?php echo $i++;?>" class="manipulate minus" title="odtaranit vykonavatele" />
        <?php
		}
        for ( ; $i < $max_of_doers; $i++ ){
        ?>
            ...
            </select><img src="imgs/delete.png" alt="minus" id="Del-Af1-<?php echo $i;?>" class="manipulate minus toHide" title="odtaranit vykonavatele" />
        <?php
        }
    ?>
    <img src="imgs/plus.png" alt="plus" id="Add-Af1" class="manipulate plus" title="přidat vykonavatele" />
    </td></tr>
    <tr><td>Počet bloků: </td><td><input class="cislo" type="text" name="colspan3" id="DB3" value="<?php echo isset($_REQUEST['colspan3']) ? $_REQUEST['colspan3'] : 1; ?>"/></td></tr>
    <tr>
        <td>Etapa:</td>
        <td><select name="etapa3">
            <option value="0" <?php if ( isset($_REQUEST['etapa3']) && $_REQUEST['etapa3'] == 0 ) echo 'selected=""'; ?>>NE</option>
            <option value="1" <?php if ( isset($_REQUEST['etapa3']) && $_REQUEST['etapa3'] == 1 ) echo 'selected=""'; ?>>ANO</option>
        </select></td>
    </tr>
    </table>
    <hr />
    ...
    <table rules="none" class="addDayTable">
    <tr><td>Program: </td><td><textarea name="Af2"><?php echo isset($_REQUEST['Af2']) ? $_REQUEST['Af2'] : ""; ?></textarea></td></tr>
    <tr><td>Má na starosti: </td><td>
    <?php
        $i = 0;
        ...
        <select name="gAf2[]" id="Af2<?php echo $i;?>">
            ...
            ?>
        </select><img src="imgs/delete.png" alt="minus" id="Del-Af2-<?php echo $i++;?>" class="manipulate minus" title="odtaranit vykonavatele" />
        <?php
		}
        for ( ; $i < $max_of_doers; $i++ ){
        ?>
            ...
            </select><img src="imgs/delete.png" alt="minus" id="Del-Af2-<?php echo $i;?>" class="manipulate minus toHide" title="odtaranit vykonavatele" />
        <?php
        }
    ?>
    <img src="imgs/plus.png" alt="plus" id="Add-Af2" class="manipulate plus" title="přidat vykonavatele" />
    </td></tr>
    <tr><td>Počet bloků: </td><td><input class="cislo" type="text" name="colspan4" id="DB4" value="<?php echo isset($_REQUEST['colspan4']) ? $_REQUEST['colspan4'] : 1; ?>"/></td></tr>
    <tr>
        <td>Etapa:</td>
        <td><select name="etapa4">
            <option value="0" <?php if ( isset($_REQUEST['etapa4']) && $_REQUEST['etapa4'] == 0 ) echo 'selected=""'; ?>>NE</option>
            <option value="1" <?php if ( isset($_REQUEST['etapa4']) && $_REQUEST['etapa4'] == 1 ) echo 'selected=""'; ?>>ANO</option>
        </select></td>
    </tr>
    </table>
    <hr />
    ...
    <table rules="none" class="addDayTable">
    <tr><td>Program: </td><td><textarea name="Nig"><?php echo isset($_REQUEST['Nig']) ? $_REQUEST['Nig'] : ""; ?></textarea></td></tr>
    <tr><td>Má na starosti: </td><td>
    <?php
        $i = 0;
        ...
        <select name="gNig[]" id="Nig<?php echo $i;?>">
            ...
            ?>
        </select><img src="imgs/delete.png" alt="minus" id="Del-Nig-<?php echo $i++;?>" class="manipulate minus" title="odtaranit vykonavatele" />
        <?php
		}
        for ( ; $i < $max_of_doers; $i++ ){
        ?>
            ...
            </select><img src="imgs/delete.png" alt="minus" id="Del-Nig-<?php echo $i;?>" class="manipulate minus toHide" title="odtaranit vykonavatele" />
        <?php
        }
    ?>
    <img src="imgs/plus.png" alt="plus" id="Add-Nig" class="manipulate plus" title="přidat vykonavatele" />
    </td></tr>
    <tr><td>Počet bloků: </td><td><input class="cislo" type="text" name="colspan5" id="DB5" value="<?php echo isset($_REQUEST['colspan5']) ? $_REQUEST['colspan5'] : 1; ?>"/></td></tr>
    <tr>
        <td>Etapa:</td>
        <td><select name="etapa5">
            <option value="0" <?php if ( isset($_REQUEST['etapa5']) && $_REQUEST['etapa5'] == 0 ) echo 'selected=""'; ?>>NE</option>
            <option value="1" <?php if ( isset($_REQUEST['etapa5']) && $_REQUEST['etapa5'] == 1 ) echo 'selected=""'; ?>>ANO</option>
        </select></td>
    </tr>
    </table>
    <hr />
