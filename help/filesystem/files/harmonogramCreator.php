...
class printHarmonogram{
	...
	public function __construct( $name = 'Harmonogram' )
	{
		...
		$this->table = 'dYearToSubStr_harmonogram';
		$this->head = array(
			'head' => array(
				'Harmonogram tábora YearToSubStr' => 'string', 
				'string2' => 'string',
				'string3' => 'string',
				'string4' => 'string',
				'string5' => 'string',
		...
		while ( $day = mysqli_fetch_array( $sql ) )
		{
			$dayn =	array(
				array(
					...
					'3' => $this->subArray( NicknameFromID( $day['vedouci'], $spojeni ), $spojeni ),
					'4' => $this->subArray( NicknameFromID( $day['gMor1'], $spojeni ), $spojeni ),
					'5' => $this->subArray( NicknameFromID( $day['gMor2'], $spojeni ), $spojeni ),
					'6' => $this->subArray( NicknameFromID( $day['gAf1'], $spojeni ), $spojeni ),
					'7' => $this->subArray( NicknameFromID( $day['gAf2'], $spojeni ), $spojeni ),
					'8' => $this->subArray( NicknameFromID( $day['gNig'], $spojeni ), $spojeni )
				),
				array(
					'1' => '',
					'2' => '',
					'3' => $this->subArray( NicknameFromID( $day['dira1'], $spojeni ), $spojeni ),
					'4' => $day['Mor1'],
					'5' => $day['Mor2'],
					'6' => $day['Af1'],
					'7' => $day['Af2'],
				...
				array(
					'1' => '', 
					'2' => '',
					'3' => $this->subArray( NicknameFromID( $day['dira2'], $spojeni ), $spojeni ),
					'4' => '',
					'5' => '',
					'6' => '',
					'7' => '',
